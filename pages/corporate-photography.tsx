...
/* ════════════════════════════════════════════════════════════════
   PHOTOGRAPHY, VIDEOGRAPHY & HEADSHOTS — Custom Landing Page
   ════════════════════════════════════════════════════════════════ */
export default function PhotographyPage() {
  ...
  return (
    <>
      <Head>
        <title>Photography, Videography & Headshots Toronto GTA | Robo Booth</title>
        <meta name="description" content="Professional Photography, Videography & Headshots for events, corporate, and private sessions across Toronto & GTA. RAW + Edited photos delivered within a week. Book now." />
        <meta name="keywords" content="event photography Toronto, videography GTA, professional headshots Toronto, corporate photography, event videographer, portrait photographer Toronto" />
        <meta property="og:title" content="Photography, Videography & Headshots | Robo Booth" />
        <meta property="og:description" content="Professional event photography, videography & headshots. RAW + Edited delivered within a week. Toronto & GTA." />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
                <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
                  ...
                  <h1 className="text-[1.65rem] leading-[1.15] md:text-4xl lg:text-5xl font-black md:leading-[1.1] mb-4">
                    Professional{' '}
                    <span className="text-[#fce4a6]">Photography, Videography & Headshots</span>{' '}
                    for Your Event.
                  </h1>
                  <p className="text-white/80 text-sm md:text-base lg:text-lg leading-relaxed mb-5 max-w-xl">
                    From candid moments to cinematic highlights and polished headshots — we capture it all. RAW + Edited photos delivered within a week.{' '}
                ...
                <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.15 }} className="hidden md:block">
                  <img src="/images/photography1.jpg" alt="Photography, Videography & Headshots" className="w-full h-[480px] lg:h-[520px] object-cover rounded-2xl shadow-2xl" loading="eager" fetchPriority="high" />
                </motion.div>

                {/* Mobile hero */}
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="md:hidden -mx-4">
                  <img src="/images/photography1.jpg" alt="Photography, Videography & Headshots" className="w-full h-60 object-cover" loading="eager" fetchPriority="high" />
                </motion.div>
              </div>
            </div>
          </section>
          ...
          <section className="py-10 md:py-14 px-4 border-t border-white/5">
            <Reveal className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-white/60 text-xs md:text-sm lg:text-base mb-5 max-w-lg mx-auto">
                Photography, videography & headshots — all handled by our team. RAW + Edited photos delivered within a week.
              </p>
        ...
        {showModal && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[60] flex items-end md:items-center justify-center bg-black/70 backdrop-blur-md p-0 md:p-4">
            <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 60 }}
              ...
              <h2 className="text-lg md:text-2xl font-black text-black mb-1 text-center">Book Photography, Videography & Headshots</h2>
...
const whatsIncluded = [
  { icon: <FiCamera className="w-5 h-5" />, title: 'Full Event Photography', desc: 'Professional photographers capture every moment — keynotes, networking, candids, details, and group shots. RAW + Edited files delivered within a week.' },
  { icon: <FiVideo className="w-5 h-5" />, title: 'Cinematic Videography', desc: 'Multi-angle video coverage with professional editing, color grading, and highlight reels. Social-ready clips included for easy sharing.' },
  { icon: <FiShield className="w-5 h-5" />, title: 'White-Glove Service', desc: 'We handle every detail — equipment, setup, coverage, and post-production. You focus on your event, we handle the rest. Full commercial usage rights included.' },
]
...
const testimonials = [
  ...
  { name: 'Lisa C.', role: 'Event Director', text: 'Having photography, videography, and headshots all from one team made everything so much easier. The quality was incredible and the turnaround was impressively fast.' },
...
const faqs = [
  ...
  { question: 'Do you offer photography, videography, and headshots separately?', answer: 'Yes. We offer flexible packages — photography only, videography only, headshots only, or any combination. We\'ll tailor the package to your exact needs.' },
