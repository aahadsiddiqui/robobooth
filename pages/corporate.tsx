...
import { corporatePackageTiers } from '../data/packageTiers'
...
export default function Corporate() {
  ...
  const packageLabel =
    packageType === 'gold' ? 'Gold Package (Corporate Multiple Robots)' :
    packageType === 'platinum' ? 'Platinum Package (Corporate Multiple Robots)' :
    packageType === 'bronze' ? 'Bronze Package (Corporate Robot Only)' :
    'General Inquiry'
    ...
    <>
      ...
      {packageType === 'gold' && (
        <div className="bg-[#fce4a6] rounded-xl px-4 py-2.5 mb-3 flex items-center justify-center gap-2 flex-wrap">
          ...
          <span className="text-black/60 text-[10px]">2 Corporate Robots</span>
        </div>
      )}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
                <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
                  ...
                  <h1 className="text-[1.65rem] leading-[1.15] md:text-4xl lg:text-5xl font-black md:leading-[1.1] mb-4">
                    Canada&apos;s First <span className="text-[#fce4a6]">Robot Photobooth</span> for Corporate Events
                  </h1>
