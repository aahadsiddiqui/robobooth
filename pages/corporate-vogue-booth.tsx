                ...
                <Reveal>
                  <div className="relative rounded-3xl border border-white/20 bg-white/[0.04] p-6 md:p-7 h-full flex flex-col">
                    ...
                    <div className="border border-white/20 rounded-xl px-4 py-3 mb-5 bg-white/[0.03]">
                      ...
                      <p className="text-white/50 text-[10px] leading-relaxed">Add professional event photography and videography for keynote moments, networking coverage, and branded content delivered within ~1 week.</p>
                    </div>
