...
export default function Birthday() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      fd.append('package', packageType === 'gold' ? 'Gold Package (Birthday Robot + Event Photography)' : packageType === 'platinum' ? 'Platinum Package (Birthday Robot + Event Photography + Second Booth)' : packageType === 'bronze' ? 'Bronze Package (Birthday Robot Only)' : 'General Inquiry')
      fd.append('_replyto', form.email); fd.append('source', 'Birthday Page')
      appendUtmParams(fd)
                ...
                <Reveal delay={0.1}>
                  <div className="relative rounded-3xl overflow-hidden border-2 border-[#fce4a6]/50 bg-gradient-to-br from-[#fce4a6]/10 via-black to-black p-6 md:p-7 shadow-2xl shadow-[#fce4a6]/10 h-full flex flex-col">
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      ...
                      <div className="space-y-2.5 mb-8 flex-1">
                        {[
                          "Canada's First Robot Photobooth roaming table-to-table",
                          'Professional event photographer covering key moments',
                          'Candid guest photography throughout the party',
                ...
                <Reveal delay={0.2}>
                  <div className="relative rounded-3xl overflow-hidden border-2 border-white/40 bg-gradient-to-br from-white/[0.08] via-black to-black p-6 md:p-7 h-full flex flex-col" style={{ boxShadow: '0 0 40px rgba(255,255,255,0.06)' }}>
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      ...
                      <p className="text-white/60 text-xs text-center mb-6">The ultimate birthday party experience — add a 360 Booth, Premium Photobooth, or Aerial Booth for maximum fun.</p>
                      <div className="space-y-2.5 mb-8 flex-1">
                        {[
                          ...
                          'The most talked-about birthday setup in the GTA',
                        ].map((b, i) => (
                          <div key={i} className="flex items-start gap-3">
            ...
            <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 60 }}
              ...
              {packageType === 'gold' && (
                <div className="bg-[#fce4a6] rounded-xl px-4 py-2.5 mb-3 flex items-center justify-center gap-2 flex-wrap">
                  ...
                  <span className="text-black/60 text-[10px]">Birthday Robot + Event Photography</span>
                </div>
              )}
