...
export default function PremiumPhotoboothPage() {
  ...
  return (
    <>
      <Head>
        <title>Premium Photobooth Rental Toronto GTA | Sleek Enclosed Photo Booth | Robo Booth</title>
        <meta name="description" content="Toronto's sleek, portable Premium Photobooth with studio-grade lighting and instant sharing. DSLR-quality photos, GIFs, and videos for weddings, corporate events, and private parties across the GTA." />
        <meta name="keywords" content="premium photobooth rental Toronto, enclosed photo booth, photo booth GTA, DSLR photo booth, instant print photo booth, wedding photo booth Toronto, corporate photo booth, portable photo booth" />
        <meta property="og:title" content="Premium Photobooth Rental Toronto GTA | Robo Booth" />
        <meta property="og:description" content="Sleek, portable photo booth with DSLR-quality photos, videos & GIFs. Instant sharing and prints. Toronto & GTA." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://robobooth.ca/premium-photobooth" />
        <link rel="canonical" href="https://robobooth.ca/premium-photobooth" />
      ...
      <div className={showModal ? 'blur-sm pointer-events-none select-none' : ''}>
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
                <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-white/60 text-xs font-medium">5.0 Rating · Toronto&apos;s Premium Photo Booth</span>
                  </div>
          ...
          <section className="py-8 md:py-10 px-4">
            <div className="max-w-5xl mx-auto">
              <Reveal className="text-center mb-5">
                ...
                <p className="text-white/50 text-xs md:text-sm">Watch how guests experience it at real events across Toronto</p>
              </Reveal>
              <Reveal delay={0.1}>
          ...
          {/* ── CTA 2 ── */}
          <CTABlock headline="Your Guests Deserve a Premium Experience." sub="Book the sleekest photo booth in Toronto." primary="Check Availability" onQuote={openQuote} phone={trackPhone} />
          ...
          {/* ── CTA 4 ── */}
          <CTABlock headline="Don't Miss Out — Dates Are Filling Fast." sub="Join 400+ events that chose the Premium Photobooth." primary="Reserve Your Date" onQuote={openQuote} phone={trackPhone} />
        ...
        {showModal && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[60] flex items-end md:items-center justify-center bg-black/70 backdrop-blur-md p-0 md:p-4">
            <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 60 }}
              ...
              <h2 className="text-lg md:text-2xl font-black text-black mb-1 text-center">Reserve the Premium Photobooth</h2>
...
const testimonials = [
  { name: 'Matthew K.', role: 'Event Organizer, Mississauga', text: 'The Premium Photobooth was compact but looked absolutely premium. Guests were blown away by the photo quality and the instant prints were a huge hit. Would definitely book again.' },
  { name: 'Garrett V.', role: 'Corporate Host, Toronto', text: 'Setup was incredibly fast and the sharing options made it so easy for our team. The branded overlays tied everything together beautifully. Best vendor decision we made.' },
...
const faqs = [
  ...
  { question: 'Do you travel outside Toronto?', answer: 'We serve Toronto and the entire GTA including Mississauga, Brampton, Vaughan, Markham, and more. We can also travel to nearby regions — just ask us about your venue location.' },
