...
export default function ThreeSixtyBoothPage() {
  ...
  return (
    <>
      <Head>
        <title>360 Photo Booth Rental Toronto GTA | Cinematic Slow-Mo Videos | Robo Booth</title>
        <meta name="description" content="Toronto's premier 360 Photo Booth rental. Cinematic slow-motion videos, instant sharing, and custom branding for weddings, corporate events, and private parties across the GTA." />
        <meta name="keywords" content="360 photo booth rental Toronto, 360 booth GTA, slow motion photo booth, cinematic video booth, wedding 360 booth, corporate 360 booth, spin booth Toronto" />
        <meta property="og:title" content="360 Photo Booth Rental Toronto GTA | Robo Booth" />
        <meta property="og:description" content="Cinematic slow-motion 360 videos with instant sharing and custom branding. Toronto & GTA." />
      ...
      <div className={showModal ? 'blur-sm pointer-events-none select-none' : ''}>
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
                <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-white/60 text-xs font-medium">5.0 Rating · Toronto&apos;s #1 360 Booth</span>
                  </div>
          ...
          {/* ── CTA 2 ── */}
          <CTABlock headline="Give Your Guests the Content They'll Actually Post." sub="The 360 Booth creates instant viral moments." primary="Check Availability" onQuote={openQuote} phone={trackPhone} />
          ...
          {/* ── CTA 4 ── */}
          <CTABlock headline="Don't Miss Out — Dates Are Filling Fast." sub="Join 500+ events that chose the 360 Booth." primary="Reserve Your Date" onQuote={openQuote} phone={trackPhone} />
        ...
        {showModal && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[60] flex items-end md:items-center justify-center bg-black/70 backdrop-blur-md p-0 md:p-4">
            <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 60 }}
              ...
              <h2 className="text-lg md:text-2xl font-black text-black mb-1 text-center">Reserve the 360 Booth</h2>
...
const testimonials = [
  { name: 'Alex P.', role: 'Brand Manager, Toronto', text: 'The 360 Booth drew a crowd all night. The slow-motion clips were incredible and every single guest posted their video. Best activation we\'ve ever booked.' },
  { name: 'Andrea M.', role: 'Event Planner, Mississauga', text: 'Setup was smooth, the attendant was amazing, and the content quality was next level. Our clients were blown away — we\'ve already booked again for the next event.' },
