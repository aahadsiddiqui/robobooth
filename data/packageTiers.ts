...
export const videoBoothPackageTiers = getDefaultPackageTiers({
  bronzeTitle: 'Robot Video Guestbook Only',
  bronzeRobotLabel: '1 Robot Video Guestbook',
  goldTitle: 'Robot Video Guestbook + Robot Photobooth',
  goldRobotLabel: 'Guestbook + Robot',
  platinumTitle: 'Multiple Robot Video Guestbooks + Robot Photobooths',
  platinumRobotLabel: 'Multiple Guestbooks',
  bronzeDesc: 'The standalone roaming Robot Video Guestbook — guests record messages while the robot moves through your venue.',
  bronzeBenefits: [
    '1 Robot Video Guestbook roaming guest-to-guest capturing video messages',
  ...
  goldDesc: 'Video messages plus photos — the Robot Video Guestbook captures the words, the Robot Photobooth captures the night.',
  goldBenefits: [
    'Robot Video Guestbook roaming the venue for personal guest messages',
  ...
  platinumDesc: 'The ultimate memory setup — multiple Robot Video Guestbooks and Robot Photobooths covering the full venue.',
  platinumBenefits: [
    'Multiple Robot Video Guestbooks capturing messages across your event',
