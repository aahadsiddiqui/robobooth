...
export const aerialPrivateCopy: AerialLandingCopy = {
  variant: 'private',
  path: '/aerial-private',
  seoTitle: 'Private Event Aerial Booth Toronto | Weddings & Galas | RoboBooth',
  seoDescription:
    'Bring Toronto’s first luxury Aerial Booth to your wedding, milestone birthday, or gala. DSLR-quality photos, premium prints, and an immersive high-angle guest experience.',
  seoKeywords:
    'wedding aerial booth Toronto, luxury photo booth private event, aerial photobooth GTA, birthday photo booth, gala photo booth Toronto',
  ogTitle: 'Toronto’s Luxury Aerial Booth for Private Events | RoboBooth',
  ogDescription:
    'Toronto’s first luxury Aerial Booth for weddings, milestone birthdays, and private galas. Premium prints, instant sharing, and a fully themed experience.',
  urgency: 'Peak weekends are filling fast',
  heroEyebrow: '5.0 on Google · Weddings, Birthdays & Galas',
  headlineLead: 'Toronto’s Luxury',
  headlineAccent: 'Aerial Booth',
  headlineRest: ' for Private Events.',
  subheadline:
    'Bring Toronto’s first luxury Aerial Booth to your wedding, milestone birthday, or gala. DSLR-quality photos, premium prints, and an immersive high-angle experience guests can’t stop talking about.',
  primaryCta: 'Secure Your Date',
  microCopy: 'Perfect for Weddings, Milestone Birthdays, and Galas.',
  heroVideo: '/videos/privateeventaerial.mp4',
  ...
  finalSub: 'Weddings, milestone birthdays, and galas book out first. We’ll confirm your date within 15 minutes.',
