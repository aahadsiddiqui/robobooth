    ...
    <>
      <div className={showModal ? 'blur-sm pointer-events-none select-none' : ''}>
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
          ...
          {/* ── CTA 2 ── */}
          <CTABlock headline="Your Guests Deserve the Best Experience." sub="Book the only robot photobooth in Canada." primary="Check Availability" onQuote={openQuote} phone={trackPhone} />
          ...
          {/* ── CTA 4 ── */}
          <CTABlock headline="Don't Miss Out — Dates Are Filling Fast." sub="Join 500+ events that chose the Robot Photobooth." primary="Reserve Your Date" onQuote={openQuote} phone={trackPhone} />
